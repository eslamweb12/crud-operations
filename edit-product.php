...
if(isset($_GET['id'])){
    $id=$_GET['id'];
    $sqll = "SELECT * from `products` where `user_id`='$user_id' and `id`='$id' ";
...
<div class="container pt-5">
    <div class="row">
        <div class="col-8 mx-auto">
            ...
            <form action="handelers/products/update.php?id=<?php echo $id;?>" method="post" class="border p-4" enctype="multipart/form-data">
                <div class="mb-3">
